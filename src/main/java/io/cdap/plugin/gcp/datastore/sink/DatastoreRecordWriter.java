...
public class DatastoreRecordWriter extends RecordWriter<NullWritable, FullEntity<?>> {
  ...
  public DatastoreRecordWriter(TaskAttemptContext taskAttemptContext) {
    ...
    Boolean isServiceAccountFilePath = Boolean.parseBoolean(config.get(
      DatastoreSinkConstants.CONFIG_SERVICE_ACCOUNT_IS_FILE));
    ...
    this.datastore = DatastoreUtil.getDatastore(serviceAccount, isServiceAccountFilePath , projectId);
