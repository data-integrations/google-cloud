 ...
 */
public final class MultiStructuredToParquetTransformer extends AbstractStructuredRecordTransformer<GenericRecord> {

  private final Map<Integer, Schema> schemaCache;

  public MultiStructuredToParquetTransformer(@Nullable co.cask.cdap.api.data.schema.Schema outputSchema) {
