 ...
 */
public final class StructuredToParquetTransformer extends RecordConverter<StructuredRecord, GenericRecord> {
  ...
  public StructuredToParquetTransformer(String outputSchema) {
