...
public class BigQueryExecuteCmekKeyTest {
  ...
  private void testValidCmekKey(BigQueryExecute.Config.Builder builder) throws Exception {
  ...
  private void testInvalidCmekKeyName(BigQueryExecute.Config.Builder builder) throws Exception {
    MockFailureCollector collector = new MockFailureCollector();
    BigQueryExecute.Config config = builder
  ...
  private void testInvalidCmekKeyLocation(BigQueryExecute.Config.Builder builder) throws Exception {
    MockFailureCollector collector = new MockFailureCollector();
    BigQueryExecute.Config config = builder
      .setCmekKey(String.format("projects/%s/locations/us-east1/keyRings/my_ring/cryptoKeys/test_key", project))
      .setLocation("us")
