 ...
 */
public class MultiStructuredToAvroTransformerTest {
    ...
    public void testAvroToStructuredRecordUnsupportedType() throws Exception {
        ...
        MultiStructuredToAvroTransformer avroToStructuredTransformer = new MultiStructuredToAvroTransformer(schema);
