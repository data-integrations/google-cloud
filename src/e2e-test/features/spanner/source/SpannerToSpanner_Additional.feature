...
Feature: Spanner source - Verification of Additional Spanner to Spanner successful data transfer without using connections
  ...
  Scenario: To verify data is getting transferred from NoSchema Spanner source to Spanner non existing sink without using connection functionality
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "Spanner" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    When Select plugin: "Spanner" from the plugins list as: "Sink"
  ...
  @SPANNER_TEST @EXISTING_SPANNER_SINK
  Scenario: To verify data is getting transferred from NoSchema Spanner source to existing Spanner sink without using connection functionality
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "Spanner" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    When Select plugin: "Spanner" from the plugins list as: "Sink"
