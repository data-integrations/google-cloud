...
Feature: BigQuery sink - Verification of BigQuery to BigQuery successful data transfer
  ...
  @BQ_INSERT_SOURCE_TEST @BQ_SINK_TEST @EXISTING_BQ_CONNECTION @BigQuery_Sink_Required @ITN_TEST
  Scenario:Verify and validate a BigQuery source to BigQuery sink end to end test case Time Partitioning Type functionality using all Daily
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    ...
    Then Enter input plugin property: "table" with value: "bqTargetTable"
    And Select radio button plugin property: "operation" with value: "upsert"
    And Select radio button plugin property: "timePartitioningType" with value: "DAY"
    Then Click on the Add Button of the property: "relationTableKey" with value:
      | TableKey |
    Then Validate "BigQuery" plugin properties
    And Close the Plugin Properties page
  ...
  @BQ_INSERT_SOURCE_TEST @BQ_SINK_TEST @EXISTING_BQ_CONNECTION @BigQuery_Sink_Required @ITN_TEST
  Scenario:Verify and validate a BigQuery source to BigQuery sink end to end test case Time Partitioning Type functionality using all Hourly
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    ...
    Then Enter input plugin property: "table" with value: "bqTargetTable"
    And Select radio button plugin property: "operation" with value: "upsert"
    And Select radio button plugin property: "timePartitioningType" with value: "HOUR"
    Then Click on the Add Button of the property: "relationTableKey" with value:
      | TableKey |
    Then Validate "BigQuery" plugin properties
    And Close the Plugin Properties page
  ...
  @BQ_INSERT_SOURCE_TEST @BQ_SINK_TEST @EXISTING_BQ_CONNECTION @BigQuery_Sink_Required @ITN_TEST
  Scenario:Verify and validate a BigQuery source to BigQuery sink end to end test case Time Partitioning Type functionality using all Monthly
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    ...
    Then Enter input plugin property: "table" with value: "bqTargetTable"
    And Select radio button plugin property: "operation" with value: "upsert"
    And Select radio button plugin property: "timePartitioningType" with value: "MONTH"
    Then Click on the Add Button of the property: "relationTableKey" with value:
      | TableKey |
    Then Validate "BigQuery" plugin properties
    And Close the Plugin Properties page
  ...
  @BQ_INSERT_SOURCE_TEST @BQ_SINK_TEST @EXISTING_BQ_CONNECTION @BigQuery_Sink_Required @ITN_TEST
  Scenario:Verify and validate a BigQuery source to BigQuery sink end to end test case Time Partitioning Type functionality using all Yearly
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
    ...
    Then Enter input plugin property: "table" with value: "bqTargetTable"
    And Select radio button plugin property: "operation" with value: "upsert"
    And Select radio button plugin property: "timePartitioningType" with value: "YEAR"
    Then Click on the Add Button of the property: "relationTableKey" with value:
      | TableKey |
    Then Validate "BigQuery" plugin properties
    And Close the Plugin Properties page
  ...
  @BQ_SOURCE_DATATYPE_TEST @BQ_SINK_TEST
  Scenario:Validate successful records transfer from BigQuery to BigQuery with Json String
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
  ...
  @BQ_SOURCE_DATATYPE_TEST @BQ_SINK_TEST
  Scenario:Validate successful records transfer from BigQuery to BigQuery with  BQ Job Labels with Key and Value pairs with BQ execute plugin
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "BigQuery" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
