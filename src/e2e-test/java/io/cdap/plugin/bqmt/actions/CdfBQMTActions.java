...
public class CdfBQMTActions implements CdfHelper {
  ...
  public static io.cdap.plugin.bqmt.locators.CdfBQMTLocators cdfBQMTLocators = null;
  ...
  public static String validateErrorColor(WebElement referenceName) throws Exception {
  ...
  public static void addComment() throws IOException {
    cdfBQMTLocators.addComment.sendKeys(SeleniumHelper.readParameters("COMMENT_BQMT"));
  }

  public static void saveComment() throws IOException {
    cdfBQMTLocators.saveComment.click();
  }
