...
public class HttpPluginLocators {
  ...
  public static WebElement httpReferenceNameError;

  @FindBy(how = How.XPATH, using = "//*[@data-cy='url' and @class='MuiInputBase-input']")
  public static WebElement httpUrl;

  @FindBy(how = How.XPATH, using = "//*[@data-cy='url']/following-sibling::div[@data-cy='property-row-error']")
  public static WebElement httpUrlError;
